...
int main()
{
	FileStorage fs("/home/loongson/Desktop/intrinsics.yml", FileStorage::READ);
	if (fs.isOpened())
	{
		cout << "read";
	...
	*/
	...
	读取图片
	*/
	rgbImageL = imread("/home/loongson/Two-eye/picture/left_0.jpg", CV_LOAD_IMAGE_COLOR);
	cvtColor(rgbImageL, grayImageL, CV_BGR2GRAY);
	rgbImageR = imread("/home/loongson/Two-eye/picture/right_0.jpg", CV_LOAD_IMAGE_COLOR);
